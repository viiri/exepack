...
;
; This also the stub produced by LINK /EXEPACK 3.61 from Microsoft C 5.0
; and Microsoft QuickBASIC Compiler 4.00, and LINK /EXEPACK 5.01.20 from
; Microsoft Macro Assembler 5.1. Thanks to Dennis Luehring for providing
